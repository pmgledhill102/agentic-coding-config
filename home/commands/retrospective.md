...
<!-- GENERATED by tests/compose-context.py from context/manifest.json.
     Skill: retrospective
     Fragments: 00-head-command, 01-shape-of-this-retro, 02-steps, 03-1-close-the-loop, 04-2-read-context, 05-3-name-the-costs-impact-first, 06-4-read-the-subtraction-instruments, 07-5-propose-at-most-three, 08-6-categorise-and-route, 09-7-propose-to-the-user, 10-8-execute, 11-9-do-not-write-to-retros-md, 12-10-brief-summary, 13-first-run-dispositions-carried-from-263, 14-guidelines, 15-what-changed-from-the-previous-versions
